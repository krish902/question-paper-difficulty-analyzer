...
```
bloom-bert-classifier/
├── data/
│   └── questions.csv              # Dataset of 3,510 labelled questions
├── notebooks/
│   └── bloom_bert_classifier.ipynb  # Full training pipeline
└── README.md
```
...
```bash
git clone https://github.com/krish902/bloom-bert-classifier
cd bloom-bert-classifier
pip install transformers tensorflow pandas numpy scikit-learn matplotlib tqdm
jupyter notebook notebooks/bloom_bert_classifier.ipynb
```
